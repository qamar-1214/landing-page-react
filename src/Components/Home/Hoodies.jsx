...
const Hoodies = () => {
  ...
  return (
    ...
    >
      <section
        id="hoodies"
        className="bg-transparent pb-40  text-center  px-16 "
      >
        <div className="absolute w-72 h-72 -top-36 p-12 -left-72 md:-left-56 lg:-left-40 border-[10px] border-primary rotate-45 bg-transparent"></div>
        <div className="absolute w-[230px] h-[230px] -top-36 -left-72 md:-left-56 lg:-left-40 border-[10px] border-primary rotate-45 bg-transparent m-8"></div>
        <h2
          data-aos="fade-up"
          data-aos-delay="300"
          className="text-yellow-500 text-4xl sm:pt-0 pb-20 sm:pb-40 relative -top-12   uppercase tracking-wide leading-[3rem] font-semibold"
        >
          unisex <br /> Hoodies
        </h2>
        ...
        <div className="absolute w-72 h-72 -top-36 p-12 -right-72 md:-right-56 lg:-right-40 border-[10px] border-primary rotate-45 bg-transparent"></div>
        <div className="absolute w-[230px] h-[230px] -top-36 -right-72 md:-right-56 lg:-right-40 border-[10px] border-primary rotate-45 bg-transparent m-8"></div>
      </section>
    </div>
  );
};
